...
const api = axios.create({
  baseURL: 'http://localhost:5000/api', // Địa chỉ API
...
export const createAuthor = async (authorData: unknown) => {
  try {
...
export const updateAuthor = async (id: number, authorData: unknown) => {
  try {
