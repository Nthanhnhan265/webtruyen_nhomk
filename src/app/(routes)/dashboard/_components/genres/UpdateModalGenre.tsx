...
// import { updateGenre } from '@/app/api/authorService';
...
interface GenreModalProps {
  ...
  onSuccess: (id: number, data: Genre) => void // Function to call on successful author creation
  initialData?: Genre | null // Optional initial data for editing
}

const UpdateGenreModal: React.FC<GenreModalProps> = ({
  show,
  onClose,
  onSuccess,
  initialData = null,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    onSuccess(initialData?.id || -1, updatedGenre)
  }
