...
const UpdateStoryModal: React.FC<StoryModalProps> = ({
  ...
  const [errors, setErrors] = useState<StoryError>()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!description.trim() || description.length < 20) {
      ...
      newErrors.description =
        'Mô tả không được chứa ký tự đặc biệt ngoài các dấu chấm, phẩy, chấm hỏi, dấu chấm than, ngoặc và gạch ngang.'
    }
            ...
            <div className="md:flex w-full">
              ...
              <div>
                <div className="flex w-full items-center justify-center relative">
                  ...
                  !coverFile ? (
                    <Image
                      src={`http://localhost:5000/${initialData.cover}`}
