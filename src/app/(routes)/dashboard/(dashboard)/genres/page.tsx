'use client'
import { createGenre, updateGenre, deleteGenre, getByGenreId, getAllgenre } from '@/app/_api/genre.api'
                ...
                <tr className="bg-white" key={genre.id}>
                  ...
                  <td className="py-2 px-1 text-center">
                    <div className="flex justify-center space-x-1">
                      <Button color="warning" onClick={() => handleEdit(genre.id)}>
                        Sửa
                      </Button>
                      <Button color="failure" onClick={() => handleDelete(genre.id)}>
                        Xóa
                      </Button>
                    </div>
                  </td>
