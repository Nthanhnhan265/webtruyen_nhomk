...
import { Avatar, Button, HR, Label, Sidebar, TextInput } from 'flowbite-react';
...
const ProfilePage = () => {
    ...
    return (
        <div className='flex flex-col min-h-screen'>
            ...
            {/* Sidebar */}
            <div className="fixed top-16 left-0 w-64 h-screen bg-gray-800 text-white"> {/* Thêm top-16 để tạo khoảng cách từ Navbar */}
                <SideBar />
            </div>

            {/* Nội dung chính */}
            <div className="flex-1 ml-64 mt-16 px-16 py-20 bg-black/5">
                {/* Thông tin tài khoản */}
